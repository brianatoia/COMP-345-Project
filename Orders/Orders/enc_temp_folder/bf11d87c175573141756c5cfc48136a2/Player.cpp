...
void Player::issueOrder(string orderType, Map* map)
{
	...
	else if (orderType == "Advance")
	{
		...
		shared_ptr<Order> order(new Advance(numOfArmies, sourceTerritory, targetTerritory, territoryList));
		this->orderList->addOrder(order);
	}
	...
	else if (orderType == "Airlift")
	{
		...
		shared_ptr<Order> order(new Airlift(numOfArmies, sourceTerritory, targetTerritory, territoryList));
		this->orderList->addOrder(order);
